    ...
    <div class="panel panel-default" style="margin-bottom: 50px;">
        <div class="panel-body">
            <div class="panel-body">
                ...
                <p class="align-center"> Próximamente estaremos cargando información sobre los eventos y charlas que se realizarán en el congreso.</p>
                <p class="align-center"> <strong>Mantente en contacto!</strong></p>
                <h5 class="align-center" style="margin-top: 20px;"><span class="highlight">{{ trans('strings.follow-us') }}</span></h5>
