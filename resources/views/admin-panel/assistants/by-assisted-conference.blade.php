                            ...
                            <div class="row">
                                <div class="col col-md-6 hidden-xs">
                                    <h3 class="panel-title">
                                        Conferencia = {{ $selectedConference->title }} <br>
                                        Cantidad de asistentes: {{ count($assistants) }}
                                    </h3>
                                </div>
                                <div class="col col-md-6 col-xs-12 align-center">
                                    <select id="filter" type="text" class="form-control" name="type" style="display:inline !important; width:50%;">
                                        @foreach ($conferences as $conference)
                                            @if($conference->slug == $selectedConference->slug)
                                                <option selected value="{{ $conference->slug }}">{{ $conference->title }}</option>
                                            @else
                                                <option value="{{ $conference->slug }}">{{ $conference->title }}</option>
                                            @endif
                                        @endforeach
                                    </select>
